...
export const Footer = () => {
  ...
  const servicesLinks = [
    ...
    { label: t('nav.webDevelopment'), href: "/web-development" },
    { label: t('nav.webAppDevelopment'), href: "/web-app-development" },
    { label: t('nav.crm'), href: "/crm" },
    { label: t('nav.chatbots'), href: "/chatbots" },
    { label: t('nav.websiteCost'), href: "/website-cost" },
