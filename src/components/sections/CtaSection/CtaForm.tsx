...
export const CtaForm = () => {
    ...
    const payload = {
        ...
        serviceType: t('cta.steps.step1.options.' + formData.serviceType),
        projectGoal: t('cta.steps.step2.options.' + formData.projectGoal),
        scale: t('cta.steps.step3.options.' + formData.scale),
        budget: t('cta.steps.step4.options.' + formData.budget),
        timeline: t('cta.steps.step5.options.' + formData.timeline),
    ...
    try {
        ...
        if (
          ...
          !sessionStorage.getItem('lead_sent')
            ...
            console.log('ADS CONVERSION FIRED');
