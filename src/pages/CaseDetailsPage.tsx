...
const CaseDetailsPage = () => {
    ...
    const heroImage = images[0]?.url || "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=800&fit=crop";
                ...
                <div className="container-custom">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                            <div className="max-w-3xl">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <span className="text-muted-foreground text-sm">{caseData.result}</span>
                                </div>
                        ...
                        <div className="lg:col-span-4 lg:pl-12">
                            <div className="p-8 rounded-3xl bg-foreground/5 border border-foreground/10 sticky top-32">
                                <div className="mb-8 aspect-square rounded-2xl overflow-hidden border border-foreground/10 group cursor-zoom-in" onClick={() => setSelectedImage(heroImage)}>
                                    <img src={heroImage} alt={caseData.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                                </div>
                                ...
                                <ul className="space-y-6">
                                    ...
                                    <li className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-medium">{caseData.result}</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-4">
                                        <div className="w-10 h-10 rounded-xl bg-foreground/5 flex items-center justify-center shrink-0">
                    ...
                    <section id="challenges" className="mb-40">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {caseData.challenges?.map((item: any, index: number) => (
                                <motion.div
                                    key={index}
                                    whileHover={{ y: -5 }}
